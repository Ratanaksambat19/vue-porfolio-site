<template>
    ...
    <svg v-if="name === 'star'" id="Group_6" data-name="Group 6" xmlns="http://www.w3.org/2000/svg" width="251.379" height="214" viewBox="0 0 251.379 214">
    ...
    <svg v-if="name === 'target'" id="Target" xmlns="http://www.w3.org/2000/svg" width="244.554" height="212.192" viewBox="0 0 244.554 212.192">
